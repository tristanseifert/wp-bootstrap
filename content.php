...
<?php if(!is_single()) { ?><h1 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'toolbox' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h1><?php } ?>
<article id="post-<?php the_ID(); ?>" class="well">
	<?php if ( 'post' == get_post_type() ) : ?>
	<div class="entry-meta" style="text-align: right; margin-bottom: -16px;">
